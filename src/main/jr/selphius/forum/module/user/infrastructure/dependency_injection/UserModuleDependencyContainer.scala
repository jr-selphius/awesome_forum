...
import jr.selphius.forum.module.user.application.{UserCreator, UserRemover, UserUpdater, UsersSearcher}
...
final class UserModuleDependencyContainer(doobieDbConnection: DoobieDbConnection)(
  ...
  val userRemover: UserRemover     = new UserRemover(repository)
}
